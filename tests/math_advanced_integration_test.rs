...
fn test_trigonometric_functions() {
    ...
    // sin(π/2) ≈ 1
    let sin_pi_2 = evaluator
        .get_variable("result4")
        .unwrap()
        .to_string()
        .parse::<f64>()
        .unwrap();
    ...
    // cos(π/2) ≈ 0
    let cos_pi_2 = evaluator
        .get_variable("result5")
        .unwrap()
        .to_string()
        .parse::<f64>()
        .unwrap();
...
fn test_math_constants() {
    ...
    let pi_times_2 = evaluator
        .get_variable("pi_times_2")
        .unwrap()
        .to_string()
        .parse::<f64>()
        .unwrap();
